...
const AcceptUsePolicy = () => {
    return (
        <div className="max-w-2xl mx-auto p-6">
            <h1 className="text-3xl font-bold mb-4">
                MOVEMINT APP INC. Acceptable Use Policy
            </h1>
            ...
            <p className="mb-4">{`
                MOVEMINT APP INC. customers found engaging in activities prohibited by this acceptable use
                policy can be liable for service suspension and account termination. In extreme cases, we
                may be legally obliged to report such customers to the relevant authorities.
            `}</p>

            <p className="mb-4">{`
                This policy was last reviewed on September 11, 2024.
            `}</p>
            ...
            <p className="mb-4">{`
                ...
                offer schedule. If your use is considered to be excessive, then additional fees may be charged
                or capacity may be restricted.
            `}</p>

            <p className="mb-4">{`
                We are opposed to all forms of abuse, discrimination, rights infringement and/or any action
                that harms or disadvantages any group, individual or resource. We expect our customers and,
                where applicable, their users ("end-users") to likewise engage our Products with similar intent.
            `}</p>
            ...
            <p className="mb-4">{`
                ...
                another group or individual. Our definition of harassment includes but is not limited to denial-of-service attacks, hate-speech, advocacy of racial or ethnic intolerance, and any activity
            ...
            <p className="mb-4">{`
                Other activities that are considered unethical, exploitative, and malicious include:
            `}</p>

            <ol className="list-disc list-inside mb-4">
                <li>Obtaining (or attempting to obtain) services from us with the intent to avoid payment;</li>
                <li>The unauthorized access, alteration or destruction (or any attempt thereof) of any
                    information about our customers or end-users, by any means or device;</li>
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-2">
                Unauthorized use of MOVEMINT APP INC. property
            </h2>

            <p className="mb-4">{`
                We prohibit the impersonation of MOVEMINT APP INC., the representation of a significant
                business relationship with MOVEMINT APP INC., or ownership of any MOVEMINT APP INC.
                property (including our Products and brand) for the purpose of fraudulently gaining service,
            ...
            <p className="mb-4">{`
                ...
                incompatible with our brand. We reserve the right to modify this policy at any time by publishing the revised version on our
                app or website. The revised version will be effective from the earlier of:
            `}</p>

            <ul className="list-disc list-inside mb-4">
                <li>
                    the date the customer uses our Products after we publish the revised version on our app or
                    website; or
                </li>
                <li>
                    30 days after we publish the revised version on our app or website.
                </li>
            </ul>
...
export default AcceptUsePolicy;